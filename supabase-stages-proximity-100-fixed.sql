-- ============================================================================
-- OPTIMUS: Stages Recuperation de Points - Comprehensive Dataset with GPS
-- ============================================================================
...
-- Create indexes for performance (simplified - no PostGIS required)
...
COMMENT ON TABLE public.stages_recuperation_points IS 'Stages de recuperation de points avec coordonnees GPS pour filtrage par proximite';
...
-- ============================================================================
-- INSERT DATA: MARSEILLE AREA (37 stages total)
-- ============================================================================

-- MARSEILLE (15 stages) - 43.2965, 5.3698
...
-- AIX-EN-PROVENCE (8 stages) - 43.5297, 5.4474
...
-- AUBAGNE (6 stages) - 43.2928, 5.5706
...
-- VITROLLES (4 stages) - 43.4553, 5.2478
...
-- LA CIOTAT (4 stages) - 43.1747, 5.6064
...
-- ============================================================================
-- INSERT DATA: LYON AREA (16 stages total)
-- ============================================================================

-- LYON (12 stages) - 45.7640, 4.8357
INSERT INTO stages_recuperation_points (city, postal_code, full_address, location_name, date_start, date_end, price, latitude, longitude) VALUES
...
-- VILLEURBANNE (4 stages) - 45.7667, 4.8797
...
('NICE', '06300', '45 avenue Malausséna', 'Formation Route Nice Est', '2026-02-11', '2026-02-12', 259.00, 43.7065, 7.2795),

-- ============================================================================
-- INSERT DATA: NANTES (6 stages)
-- ============================================================================
...
-- ============================================================================
-- INSERT DATA: MONTPELLIER (5 stages)
-- ============================================================================
...
-- ============================================================================
-- INSERT DATA: STRASBOURG (5 stages)
-- ============================================================================
...
-- Count total stages
-- SELECT COUNT(*) as total_stages FROM stages_recuperation_points;

-- Count stages by city
-- SELECT city, COUNT(*) as count FROM stages_recuperation_points GROUP BY city ORDER BY count DESC, city;

-- Show all stages with distance calculation example (using simple formula, no PostGIS needed)
-- Note: JavaScript will handle distance calculations in the frontend
-- SELECT
--   city,
--   postal_code,
--   full_address,
...
-- ORDER BY date_start, city;

-- ============================================================================
-- NOTES FOR PROXIMITY FILTERING
-- ============================================================================
-- Distance calculation is done in JavaScript using Haversine formula
-- No PostGIS extension needed for Supabase
-- Frontend fetches all stages and calculates distances client-side
-- Default radius: 30km
-- ============================================================================
